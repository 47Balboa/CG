...
void saveFile(Struct *p, string nomeF) {
	...
	if (file.is_open()) { // verifica se foi aberto
		...
		file << to_string(normal.size()) << endl;							// escreve no ficheiro o tamanho da lista das normais
		...
		file << to_string(textura.size()) << endl;                          // escreve no ficheiro o tamanho da lista das texturas
